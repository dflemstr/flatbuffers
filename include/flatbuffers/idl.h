...
#define FLATBUFFERS_GEN_TYPES_POINTER(TD) \
  TD(STRING, "string", Offset<void>, int, int, StringOffset, int, u32) \
  TD(VECTOR, "",       Offset<void>, int, int, VectorOffset, int, u32) \
  TD(STRUCT, "",       Offset<void>, int, int, int, int, u32) \
  TD(UNION,  "",       Offset<void>, int, int, int, int, u32)
